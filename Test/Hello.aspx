<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hello.aspx.cs" Inherits="Test.Hello" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Login ID="Login" runat="server" OnAuthenticate="Login1_Authenticate" Width="298px">
            <LayoutTemplate>
                <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                    <tr>
                        <td>
                            <table cellpadding="0" style="width:298px;">
                                <tr>
                                ...
                                <tr>
                                    <td align="right" colspan="2">
                                        <asp:Button ID="LoginButton" runat="server" CommandName="Login" OnClick="LoginButton_Click" Text="Log In" ValidationGroup="Login" />
                                    </td>
                                </tr>
                            </table>
                        </td>
